...
import com.wh.test.netty.customer.marshalling.MarshallingDecoder;
...
public final class NettyMessageDecoder extends LengthFieldBasedFrameDecoder{
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        if(size > 0){
            Map<String, Object> attchments = new HashMap<String, Object>(size);
            int keySize = 0;
            byte[] keyArray = null;
            String key = null;
            for(int i=0; i<size; i++){
                ...
                attchments.put(key, marshallingDecoder.decode(frame));
            }

            keyArray = null;
            key = null;
            header.setAttachment(attchments);
